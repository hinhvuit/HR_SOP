<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListRegisterPublishDocument.aspx.cs" Inherits="HR_SOP.ListRegisterPublishDocument" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<td> <a href="RegisterPublishDocument.aspx?CodeDocument=' + v.CodeDocument + '&DocNo=' + v.DocNo + '">' + v.DocNo + '</a></td>';
