<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="ListCheckWait.aspx.cs" Inherits="HR_SOP.ListCheckWait" %>
    ...
    <script type="text/javascript">
        ...
        function ListCheckWait(Code, Dcc, Department, CheckWait, CreatedBy, sFromDate, sToDate, Type) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListCheckWait',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        if (v.Code == 'CODE') {
                            html += '<td> <a href="RegisterCodeDocument.aspx?CodeDocument=' + v.CodeDocument + '">' + v.CodeDocument + '</a></td>';
                        }
                        else if (v.Code == 'PUB'){
                            html += '<td> <a href="RegisterPublishDocument.aspx?PublishDocument=' + v.CodeDocument + '">' + v.CodeDocument + '</a></td>';
                        }
                        else if (v.Code == 'EDIT') {
                            html += '<td> <a href="RegisterEditDocument.aspx?EditDocument=' + v.CodeDocument + '">' + v.CodeDocument + '</a></td>';
                        }
                        else if (v.Code == 'CANCEL') {
                            html += '<td> <a href="RegisterCancelDocument.aspx?CancelDocument=' + v.CodeDocument + '">' + v.CodeDocument + '</a></td>';
                        }
                        else if (v.Code == 'OBS') {
                            html += '<td> <a href="ApplicationObsoletedDocument.aspx?ObsoletedDocument=' + v.CodeDocument + '">' + v.CodeDocument + '</a></td>';
                        }
                        else {
