<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterEditDocument.aspx.cs" Inherits="HR_SOP.RegisterEditDocument" %>
    ...
    <script type="text/javascript">
        ...
        function ListPublishReffByEditDocument(EditDocument) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListPublishReffByEditDocument',
       ...
       function ShowDoc() {
        ...
        function ShowOrHide(EditDocument) {
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/CheckDisplaySubmitEditDocument',
                data: "{ 'EditDocument': '" + EditDocument + "'}",
                async: true,
                success: function (data) {
                    $.each($.parseJSON(data.d), function (i, v) {
        ...
        setTimeout(function () {
            ...
            if (ContentFile == '' && ContentFile_old =='')
            {
                ...
                $.ajax({
                    ...
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    url: 'Models/WebServiceDB.asmx/InsertOrUpdateRegisterEditDocument',
                    ...
                    success: function (data) {
                        if ($.parseJSON(data.d) == 'ERROR') {
                            ...
                            function (isConfirm) {
                                if (isConfirm) {
                                    location.href = 'RegisterEditDocument.aspx?EditDocument=' + $.parseJSON(data.d);
                                }
                            });
                        }
                    },
    ...
    function (isConfirm) {
        ...
        if (isConfirm === "") {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/AcceptRegisterEditDocument',
                ...
                success: function (data) {
                    if ($.parseJSON(data.d) == 'SUCCESS') {
                        location.href = "ListEditDocument.aspx";
                    }
                    else {
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/DeletedRegisterEditDocument',
...
function (isConfirm) {
    if (isConfirm === false) {
        ...
        $.ajax({
            ...
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            url: 'Models/WebServiceDB.asmx/RejectRegisterEditDocument',
