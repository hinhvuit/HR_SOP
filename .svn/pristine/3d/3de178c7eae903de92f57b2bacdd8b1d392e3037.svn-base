...
{
    public class ApplicationObsoletedDocumentMN
    {
            ...
            string DocNo,string DocName,string Department,DateTime FromApplicationDate, DateTime ToApplicationDate)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "sp_ListApplicationObsoletedDocument";
            ...
            DateTime EffectiveDate, string ReasonObsoleted,string States,DateTime ApplicationDate, string Users)
        {
            try
            {
                ...
                {
                    #region
                    cmd.CommandText = @"insert into ApplicationObsoletedDocument(ID,ObsoletedDocument,PublishDocument,EffectiveDate,ReasonObsoleted,States,ApplicationDate,CreatedBy,CreatedDate,IsDeleted) 
                ...
                {
                    #region
                    cmd.CommandText = @"update ApplicationObsoletedDocument set EffectiveDate=@EffectiveDate,
        ...
        public int InsertApprovalSection_ObsoletedDocument(string ObsoletedDocument, string UserName)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_InsertApprovalSection_ObsoletedDocument";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@ObsoletedDocument", ObsoletedDocument);
        ...
        public DataTable CheckDisplaySubmitObsoletedDocument(string ObsoletedDocument, string LoginName)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckDisplaySubmitObsoletedDocument";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@ObsoletedDocument", ObsoletedDocument);
        ...
        public int AcceptAcceptApplicationObsoletedDocument(string ObsoletedDocument, string User, string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_AcceptApplicationObsoletedDocument";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@ObsoletedDocument", ObsoletedDocument);
                cmd.Parameters.AddWithValue("@States", States);
        ...
        public int RejectApplicationObsoletedDocument(string ObsoletedDocument, string User, string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update ApplicationObsoletedDocument set States ='" + States + "',UpdatedBy='" + User + "',UpdatedDate=GETDATE() where ObsoletedDocument = '" + ObsoletedDocument + "'";
                cmd.ExecuteNonQuery();
                aConnectionSQL.Close();
                return 1;
            }
        ...
        public int CheckApprovalSection_ObsoletedDocument(string ObsoleteDocument,string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckApprovalSection_ObsoletedDocument";
                cmd.Parameters.Clear();
        ...
        public int DeletedApplicationObsoletedDocument(string ID, string User)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = @" update ApplicationObsoletedDocument set IsDeleted = 1,DeletedBy='" + User + "',DeletedDate=GETDATE() where ID = '" + ID + "' " 
                                + " update RegisterPublishDocument set Type='1' where PublishDocument=(select top 1 PublishDocument from ApplicationObsoletedDocument where ID='"+ ID + "')";
                cmd.ExecuteNonQuery();
                aConnectionSQL.Close();
                return 1;
            }
        ...
        public DataTable CheckListSendMail_Obsoleted(string ObsoletedDocument)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckListSendMail_Obsoleted";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@ObsoletedDocument", ObsoletedDocument);
                SqlDataAdapter ds_adapter = new SqlDataAdapter();
                ds_adapter.SelectCommand = cmd;
