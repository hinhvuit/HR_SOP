<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListPublishDocument.aspx.cs" Inherits="HR_SOP.ListPublishDocument" %>
    ...
    <script type="text/javascript">
        ...
        function ListRegisterPublishDocument(PublishDocument, CreatedBy,DocumentNo, DocumentName, IndexWord,Department, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterPublishDocument',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="RegisterPublishDocument.aspx?PublishDocument=' + v.PublishDocument + '">' + v.PublishDocument + '</a></td>';
