<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListCodeDocument.aspx.cs" Inherits="HR_SOP.ListCodeDocument" %>
    ...
    <script type="text/javascript">
        ...
        function ListRegisterCodeDocument(CodeDocument, CreatedBy,Department,DocNo,DocName, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterCodeDocument',
