<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListReleasedForm.aspx.cs" Inherits="HR_SOP.ListReleasedForm" %>
    ...
    <script type="text/javascript">
        ...
        function ListPublishReff(FormNo, FormName, PreservingDepartment, sFromDate, sToDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListPublishReff',
