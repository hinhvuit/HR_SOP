<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListObsoletedDocument.aspx.cs" Inherits="HR_SOP.ListObsoletedDocument" %>
    ...
    <script type="text/javascript">
        ...
        function ListApplicationObsoletedDocument(ObsoletedDocument, CreatedBy,DocNo,DocName,Department, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListApplicationObsoletedDocument',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="ApplicationObsoletedDocument.aspx?ObsoletedDocument=' + v.ObsoletedDocument + '">' + v.ObsoletedDocument + '</a></td>';
