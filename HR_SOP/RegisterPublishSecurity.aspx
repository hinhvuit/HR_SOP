    ...
    <script type="text/javascript">
                        ...
                        if ($('#<%=txtFormNo.ClientID%>').val() == '') {
                            ...
                            if (ext != 'doc' && ext != 'docx' && ext != 'xls' && ext != 'xlsx' && ext != 'pdf') {
                                ...
                                $.ajax({
                                    ...
                                    processData: false,
                                    dataType: 'text',
                                    url: 'Models/WebServiceDB.asmx/SaveFilePublishRefferentSe',
                                    data: data,
                                    async: true,
            ...
            $('#tr_reff_' + $(row).attr('value') + ' td').each(function (i) {
                if (i == 5) {
                    $.ajax({
                        ...
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        url: 'Models/WebServiceDB.asmx/DeleteFilePublishRefferentSe',
        ...
        function LoadPublishRefferent(PublishDocument) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListPublishReffByPublishSecurity',
        ...
        function ShowDoc() {
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/CheckExistsFilePublishSecurity',
        ...
        function ShowNeed() {
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/CheckExistsFilePublishSecurityNeed',
   ...
   if ($('#FileName').val() == '' && $('#<%=hidFileName.ClientID%>').val() == '') {
        ...
        if (extNeed != '') {
            ...
            $.ajax({
                ...
                processData: false,
                dataType: 'text',
                url: 'Models/WebServiceDB.asmx/SaveFilePublishNeedReleaseSe',
                data: dataNeed,
                async: true,
                success: function (data) {
...
function SearchRegisterPublishDocument(PublishDocument) {
    ...
    $.ajax({
        ...
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        url: 'Models/WebServiceDB.asmx/SearchRegisterPublishSecurity',
