<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListRegisterCancelSecurity.aspx.cs" Inherits="HR_SOP.ListRegisterCancelSecurity" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ListRegisterPublishDocument($('#<%=txtCodeDocument.ClientID%>').val(), $('#<%=txtDCC.ClientID%>').val(), $('#<%=txtFromApplicationDate.ClientID%>').val(), $('#<%=txtToApplicationDate.ClientID%>').val());
            }, 500);
        });
        ...
        function ListRegisterPublishDocument(PublishDocument, DCC, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterPublishSecurityByType',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="RegisterEditSecurity.aspx?PublishDocument=' + v.PublishDocument + '">' + v.PublishDocument + '</a></td>';
    ...
    <div class="panel panel-flat border-top-grey-300 border-right-grey-300 border-bottom-grey-300 border-left-grey-300">
        <div class="panel-heading">
            <h5 class="bg-info p-5">文件修改申請單 / ĐƠN XIN SỬA VĂN BẢN</h5>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr class="bg-info">
                                            ...
                                            <th class="text-bold col-lg-2">Mã đơn<br />申請單編號 </th>
                                            ...
                                            <%--<th class="text-bold col-lg-2">Ngày có hiệu lực<br />生效日期</th>--%>
                                        </tr>
                                    </thead>
                                    <tbody id="bodyApp">
                                        <tr>
