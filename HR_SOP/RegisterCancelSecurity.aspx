<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterCancelSecurity.aspx.cs" Inherits="HR_SOP.RegisterCancelSecurity" %>
    ...
    <script type="text/javascript">
        ...
        function ShowOrHide(CancelDocument) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/CheckDisplaySubmitCancelSecurity',
...
function Luu() {
    if ($('#<%=ddlDepartment.ClientID%>').val() == null) {
        ...
        $.ajax({
            ...
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            url: 'Models/WebServiceDB.asmx/InsertOrUpdateRegisterCancelSecurity',
            ...
            success: function (data) {
                if ($.parseJSON(data.d) == 'ERROR') {
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            location.href = 'RegisterCancelSecurity.aspx?CancelDocument=' + $.parseJSON(data.d);
                        }
                    });
                }
            },
    ...
    function (isConfirm) {
        if (isConfirm === false) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/AcceptRegisterCancelSecurity',
                ...
                success: function (data) {
                    if ($.parseJSON(data.d) == 'SUCCESS') {
                        location.href = "ListCancelSecurity.aspx";
                    }
                    else {
                        swal({
                            title: "通報 / Thông báo",
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/DeletedRegisterCancelSecurity',
    ...
    function (isConfirm) {
        if (isConfirm === false) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/RejectRegisterCancelSecurity',
