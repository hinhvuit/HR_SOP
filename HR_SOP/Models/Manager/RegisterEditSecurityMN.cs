...
{
    public class RegisterEditSecurityMN
    {
            ...
            string DocumentNo, string DocumentName, string IndexWord, string Department, DateTime FromApplicationDate, DateTime ToApplicationDate)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "sp_ListRegisterEditSecurity";
            ...
            DateTime ApplicationDate, string DepartmentCheck, string CodeDocument, string Department)
        {
            try
            {
                ...
                {
                    #region
                    cmd.CommandText = "Insert into RegisterEditSecurity(ID,EditDocument,PublishDocument,CreatedBy,CreatedDate,ApplicationSite,EffectiveDate,DocumentNo,Rev,"
                ...
                {
                    #region
                    cmd.CommandText = "update RegisterEditSecurity set EditDocument=@EditDocument, PublishDocument=@PublishDocument,ApplicationSite=@ApplicationSite,EffectiveDate=@EffectiveDate,DocumentNo=@DocumentNo,"
        ...
        public DataTable CheckDisplaySubmitEditDocument(string EditDocument, string LoginName)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckDisplaySubmitEditSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@EditDocument", EditDocument);
        ...
        public int AcceptRegisterEditDocument(string EditDocument, string User, string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_AcceptRegisterEditSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@EditDocument", EditDocument);
                cmd.Parameters.AddWithValue("@States", States);
        ...
        public int RejectRegisterEditDocument(string EditDocument, string User, string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update RegisterEditSecurity set States ='" + States + "',UpdatedBy='" + User + "',UpdatedDate=GETDATE() where EditDocument = '" + EditDocument + "'";
                cmd.ExecuteNonQuery();
                aConnectionSQL.Close();
                return 1;
            }
        ...
        public int DeletedRegisterEditDocument(string ID, string User)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update RegisterEditSecurity set IsDeleted = 1,DeletedBy='" + User + "',DeletedDate=GETDATE() where ID = '" + ID + "'"
                                + "declare @PublishDocument varchar(50)"
                                + " select top 1 @PublishDocument=PublishDocument  from RegisterEditDocument where ID ='" + ID + "'"
                                + " update RegisterPublishSecurity set [Type] = '1' where PublishDocument=@PublishDocument";
        ...
        public DataTable CheckListSendMail_Edit(string EditDocument)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckListSendMail_EditSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@EditDocument", EditDocument);
                SqlDataAdapter ds_adapter = new SqlDataAdapter();
                ds_adapter.SelectCommand = cmd;
