...
{
    public class RegisterCancelSecurityMN
    {
            ...
            DateTime FromApplicationDate, DateTime ToApplicationDate)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "sp_ListRegisterCancelSecurity";
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(ID))
                {
                    ...
                    cmd.CommandText = " insert into "
                                    + " RegisterCancelSecurity(ID, CancelDocument, ApplicationDate, EffectiveDate, ApplicationSite, CloseDocument, "
                ...
                {
                    #region
                    cmd.CommandText = "update RegisterCancelSecurity set CancelDocument=@CancelDocument,ApplicationDate=@ApplicationDate, "
        ...
        public int DeletedRegisterCancelDocument(string ID, string User)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update RegisterCancelSecurity set IsDeleted = 1,DeletedBy='" + User + "',DeletedDate=GETDATE() where ID = '" + ID + "'"
        ...
        public int RejectRegisterCancelDocument(string CancelDocument, string User, string States)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update RegisterCancelSecurity set States ='" + States + "',UpdatedBy='" + User + "',UpdatedDate=GETDATE() where CancelDocument = '" + CancelDocument + "'";
                cmd.ExecuteNonQuery();
                aConnectionSQL.Close();
                return 1;
            }
        ...
        public int InsertApprovalSection_CancelDocument(string CancelDocument, string UserName, string Department)
        {
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_InsertApprovalSection_CancelSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@CancelDocument", CancelDocument);
        ...
        public DataTable CheckListSendMail_Cancel(string CancelDocument)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckListSendMail_CancelSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@CancelDocument", CancelDocument);
                SqlDataAdapter ds_adapter = new SqlDataAdapter();
                ds_adapter.SelectCommand = cmd;
        ...
        public DataTable sp_CheckDisplaySubmitCancelDocument(string CancelDocument)
        {
            ...
            try
            {
                ...
                cmd.Connection = aConnectionSQL.Connection();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "sp_CheckDisplaySubmitCancelSecurity";
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@CancelDocument", CancelDocument);
