<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApplicationObsoletedSecurity.aspx.cs" Inherits="HR_SOP.ApplicationObsoletedSecurity" %>
    ...
    <script type="text/javascript">
        ...
        function ShowOrHide(ObsoletedDocument) {
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/CheckDisplaySubmitObsoletedSecurity',
...
function Luu() {
    if ($('#<%=txtReasonObsoleted.ClientID%>').val() == '') {
        ...
        $.ajax({
            ...
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            url: 'Models/WebServiceDB.asmx/InsertOrUpdateApplicationObsoletedSecurity',
            ...
            success: function (data) {
                if ($.parseJSON(data.d) == 'ERROR') {
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            location.href = 'ApplicationObsoletedSecurity.aspx?ObsoletedDocument=' + $.parseJSON(data.d);
                        }
                    });
                }
            },
    ...
    function (isConfirm) {
        if (isConfirm === false) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/AcceptAcceptApplicationObsoletedSecurity',
                ...
                success: function (data) {
                    if ($.parseJSON(data.d) == 'SUCCESS') {
                        location.href = "ListObsoletedSecurity.aspx";
                    }
                    else {
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/DeletedApplicationObsoletedSecurity',
...
function (isConfirm) {
    if (isConfirm === false) {
        ...
        $.ajax({
            ...
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            url: 'Models/WebServiceDB.asmx/RejectApplicationObsoletedSecurity',
