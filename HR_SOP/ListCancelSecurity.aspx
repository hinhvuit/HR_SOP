<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListCancelSecurity.aspx.cs" Inherits="HR_SOP.ListCancelSecurity" %>
    ...
    <script type="text/javascript">
        ...
        function ListRegisterCancelDocument(CancelDocument,DocNo_DCC,DocName, CreatedBy,Department, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterCancelSecurity',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="RegisterCancelSecurity.aspx?CancelDocument=' + v.CancelDocument + '">' + v.CancelDocument + '</a></td>';
                        html += '<td>' + v.DocNo + '</td>';
