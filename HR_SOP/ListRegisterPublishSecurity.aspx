<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListRegisterPublishSecurity.aspx.cs" Inherits="HR_SOP.ListRegisterPublishSecurity" %>
    ...
    <script type="text/javascript">
        ...
        function ListRegisterCodeDocumentByDCC(CodeDocument, DocNo, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterCodeSecurityByDCC',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<td> <a href="RegisterPublishSecurity.aspx?CodeDocument=' + v.CodeDocument + '&DocNo=' + v.DocNo + '">' + v.DocNo + '</a></td>';
