<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="ListRegisterEditDocument.aspx.cs" Inherits="HR_SOP.ListRegisterEditDocument" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="RegisterEditDocument.aspx?PublishDocument=' + v.PublishDocument + '">' + v.PublishDocument + '</a></td>';
