<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListEditDocument.aspx.cs" Inherits="HR_SOP.ListEditDocument" %>
    ...
    <script type="text/javascript">
        ...
        function ListRegisterEditDocument(EditDocument, CreatedBy, DocumentNo, DocumentName, IndexWord,Department, fApplicationDate, tApplicationDate) {
            $.ajax({
                ...
                dataType: 'json',
                url: 'Models/WebServiceDB.asmx/ListRegisterEditDocument',
                ...
                success: function (data) {
                    ...
                    $.each($.parseJSON(data.d), function (i, v) {
                        ...
                        html += '<tr>';
                        html += '<td>' + (i + 1) + '</td>';
                        html += '<td> <a href="RegisterEditDocument.aspx?EditDocument=' + v.EditDocument + '">' + v.EditDocument + '</a></td>';
